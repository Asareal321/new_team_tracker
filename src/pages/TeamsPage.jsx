      ...
      <div className="team-detail-col">
        ...
        {!currentTeam ? (
          ...
          <>
            ...
            {/* One level. Projects used to be groups of sprints; the grouping
                is gone and what was a sprint is simply a project now. */}
            <section className="projects-section">
              ...
              <div className="project-grid">
                ...
                {projectFilter === 'mine' && projects.length > 0 &&
                  ...
                  <p className="empty-hint">You’re not on any projects here yet — switch to "All" to see the community’s.</p>
                )}
              </div>
            </section>
